...
namespace ControllerTest
{
    ...
    public class Model_Competition_ContestorData
    {
        ...
        public void Setup()
        {
            ...
            _competition.Contestors.Add(new Driver("Test1", new Car()));
            _competition.Contestors.Add(new Driver("Test2", new Car()));
        }
        ...
        {
            _competition.ContestorBrokenCount(_competition.Contestors[0], 1);
            _competition.ContestorBrokenCount(_competition.Contestors[1], 1);
            var expected = _competition.Contestors[0].Name;
